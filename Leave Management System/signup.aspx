        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style3">
                    <asp:Label ID="Label4" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="Black" Text="Sex:"></asp:Label>
                </td>
                <td class="auto-style10">
                    <asp:RadioButtonList ID="rblSex" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="Black" RepeatDirection="Horizontal">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label5" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="Black" Text="Email Address:"></asp:Label>
                </td>
                <td class="auto-style9">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label6" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="Black" Text="Phone Number:"></asp:Label>
                </td>
                <td class="auto-style9">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label7" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="Black" Text="Country:"></asp:Label>
                </td>
                <td class="auto-style9">
                    <asp:DropDownList ID="ddlCountry" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="Black">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Label ID="Label8" runat="server" Font-Names="Arial" Font-Size="Medium" ForeColor="Black" Text="Username"></asp:Label>
                </td>
                <td class="auto-style9">
            ...
            <tr>
                <td class="auto-style2">
                    <asp:Button ID="btnSubmit" runat="server" Font-Bold="True" Font-Names="Arial Black" Font-Size="Medium" ForeColor="Black" OnClick="btnSubmit_Click" Text="Submit" />
                </td>
            ...
            <tr>
                <td colspan="2">
            <asp:Label ID="lblMsg" runat="server" Font-Names="Calibri" Font-Size="XX-Large" ForeColor="Black"></asp:Label>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
